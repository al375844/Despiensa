...
export default class App extends Component{
    ...
    updateProfile = () => {
        const url = `http://192.168.1.199:3000/users/modifyUser/${this.state.usuario}/${this.state.usuario}/${this.state.nombreUsuario}/${this.state.apellidosUsuario}/${this.state.correo}`;
        fetch(url, {
            method: 'PUT'
